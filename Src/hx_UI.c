...
void UI_InitSetupVariable(void)    //Ω√Ω∫≈€ √ ±‚»≠ Ω√ø° 1π¯ «œ∏Á  EEPROM ø°º≠ ∫“∑ØøÕ¡ˆ∏È ¡ˆøˆ¡¸
{
...
void UI_InitVariable(void) // «√∑π¿Ã ªÛø°»∆∑√ øœ∑· »ƒ ¥ŸΩ√ µπæ∆    ø¿∏È  
{
	//int i;
